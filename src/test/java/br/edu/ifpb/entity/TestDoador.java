...
public class TestDoador {
    ...
    public void testDoador(){
        ...
        Doador falsoDoador = new DoadorFeminino();
        ...
        Assert.assertEquals("F",doador.getEstaDoente());
        ...
        Assert.assertNull(falsoDoador.getEstaDoente());
        //testes negativos
